...
_C.DATASET.ANSWER_VOCAB_SIZE = 9
...
# ------------------------------------------------------------------------------------- #
# Common dataset options for SpaSen
# ------------------------------------------------------------------------------------- #
_C.DATAPATH = 'data/spasen/annotations.json'
_C.IMAGEPATH = 'data/spasen/images'
_C.MAX_PHRASE_LEN = 2
_C.PREDICATE_CATEGORIES = ['above', 'behind', 'in', 'in front of', 'next to', 'on',
