...
import pprint
# from SpatialSense.baselines.dataloader import SpatialDataset

DATASET_CATALOGS = {'spasen': SpaSen}
...
def make_dataloader(cfg, dataset=None, mode='train', distributed=False, num_replicas=None, rank=None,
    ...
    if dataset is None:
        ...
        dataset = build_dataset(cfg.DATASET.DATASET, mode, cfg, transform)
