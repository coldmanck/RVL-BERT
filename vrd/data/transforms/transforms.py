...
class Compose(object):
    ...
    def __call__(self, image, boxes, masks, predicate, im_info, flipped):
        for t in self.transforms:
            image, boxes, masks, predicate, im_info, flipped = t(image, boxes, masks, predicate, im_info, flipped)
        return image, boxes, masks, predicate, im_info, flipped
...
class ToTensor(object):
    def __call__(self, image, boxes, masks, predicate, im_info, flipped):
        return F.to_tensor(image) if image is not None else image, boxes, masks, predicate, im_info, flipped # and not isinstance(image, torch.Tensor)
