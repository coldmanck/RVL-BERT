...
from vrd.function.config import config, update_config
from vrd.function.test import test_net
...
def main():
    ...
    recall, recall_100 = test_net(args, config, ckpt_path=args.ckpt, save_path=args.result_path, 
                          save_name=args.result_name)

    print('\ttesting recall@50 = %.5f' % recall)
    print('\ttesting recall@100 = %.5f' % recall_100)
